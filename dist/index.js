...
export function cloud(w, h, l, r, t, b, ) {
    ...
    return [`M${3900},${14370}A${6753},${9190},0,0,1,${},${}A${5333},${7267},0,0,1,${},${}A${4365},${5945},0,0,1,${},${}A${4857},${6595},0,0,1,${},${}A${5333},${7273},0,0,1,${},${}A${6775},${9220},0,0,1,${},${}A${5785},${7867},0,0,1,${},${}A${6752},${9215},0,0,1,${},${}A${7720},${10543},0,0,1,${},${}A${4360},${5918},0,0,1,${},${}A${4345},${5945},0,0,1,${},${}Z`, `M${4693},${26177}A${4345},${5945},0,0,1,${},${}M${6928},${34899}A${4360},${5918},0,0,1,${},${}M${16478},${39090}A${6752},${9215},0,0,1,${},${}M${28827},${34751}A${6752},${9215},0,0,1,${},${}M${34129},${22954}A${5785},${7867},0,0,1,${},${}M${41798},${15354}A${5333},${7273},0,0,1,${},${}M${38324},${5426}A${4857},${6595},0,0,1,${},${}M${29078},${3952}A${4857},${6595},0,0,1,${},${}M${22141},${4720}A${4365},${5945},0,0,1,${},${}M${14000},${5192}A${6753},${9190},0,0,1,${},${}M${4127},${15789}A${6753},${9190},0,0,1,${},${}`]
}
export function cloudCallout(w, h, l, r, t, b, adj1, adj2) {
    ...
    return [`M${3900},${14370}A${6753},${9190},0,0,1,${},${}A${5333},${7267},0,0,1,${},${}A${4365},${5945},0,0,1,${},${}A${4857},${6595},0,0,1,${},${}A${5333},${7273},0,0,1,${},${}A${6775},${9220},0,0,1,${},${}A${5785},${7867},0,0,1,${},${}A${6752},${9215},0,0,1,${},${}A${7720},${10543},0,0,1,${},${}A${4360},${5918},0,0,1,${},${}A${4345},${5945},0,0,1,${},${}Z`, `M${x23},${yPos}A${g26},${g26},0,0,1,${},${}Z`, `M${x24},${g17}A${g25},${g25},0,0,1,${},${}Z`, `M${x25},${g24}A${g12},${g12},0,0,1,${},${}Z`, `M${4693},${26177}A${4345},${5945},0,0,1,${},${}M${6928},${34899}A${4360},${5918},0,0,1,${},${}M${16478},${39090}A${6752},${9215},0,0,1,${},${}M${28827},${34751}A${6752},${9215},0,0,1,${},${}M${34129},${22954}A${5785},${7867},0,0,1,${},${}M${41798},${15354}A${5333},${7273},0,0,1,${},${}M${38324},${5426}A${4857},${6595},0,0,1,${},${}M${29078},${3952}A${4857},${6595},0,0,1,${},${}M${22141},${4720}A${4365},${5945},0,0,1,${},${}M${14000},${5192}A${6753},${9190},0,0,1,${},${}M${4127},${15789}A${6753},${9190},0,0,1,${},${}`]
}
...
export function flowChartDisplay(w, h, l, r, t, b, ) {
    ...
    const ss = w < h ? w : h
    const x2 = w * _5 / _6
    return [`M${0},${3}L${1},${0}L${5},${0}A${1},${3},0,0,1,${},${}L${1},${6}Z`]
}
...
export function flowChartMagneticDisk(w, h, l, r, t, b, ) {
    ...
    const ss = w < h ? w : h
    const y3 = h * _5 / _6
    return [`M${0},${1}A${3},${1},0,0,1,${},${}L${6},${5}A${3},${1},0,0,1,${},${}Z`, `M${6},${1}A${3},${1},0,0,1,${},${}`, `M${0},${1}A${3},${1},0,0,1,${},${}L${6},${5}A${3},${1},0,0,1,${},${}Z`]
}
export function flowChartMagneticDrum(w, h, l, r, t, b, ) {

    const ss = w < h ? w : h
    const x2 = w * _2 / _3
    return [`M${1},${0}L${5},${0}A${1},${3},0,0,1,${},${}L${1},${6}A${1},${3},0,0,1,${},${}Z`, `M${5},${6}A${1},${3},0,0,1,${},${}`, `M${1},${0}L${5},${0}A${1},${3},0,0,1,${},${}L${1},${6}A${1},${3},0,0,1,${},${}Z`]
}
...
export function flowChartOnlineStorage(w, h, l, r, t, b, ) {
    ...
    const ss = w < h ? w : h
    const x2 = w * _5 / _6
    return [`M${1},${0}L${6},${0}A${1},${3},0,0,1,${},${}L${1},${6}A${1},${3},0,0,1,${},${}Z`]
}
...
export function flowChartPunchedTape(w, h, l, r, t, b, ) {
    ...
    const y2 = h * _9 / _10
    const ib = h * _4 / _5
    return [`M${0},${2}A${5},${2},0,0,1,${},${}A${5},${2},0,0,1,${},${}L${20},${18}A${5},${2},0,0,1,${},${}A${5},${2},0,0,1,${},${}Z`]
}
...
export function flowChartTerminator(w, h, l, r, t, b, ) {
    ...
    return [`M${3475},${0}L${18125},${0}A${3475},${10800},0,0,1,${},${}L${3475},${21600}A${3475},${10800},0,0,1,${},${}Z`]
}
