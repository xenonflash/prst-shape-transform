 ...
 */
export default function arcToPathA(wR, hR, startAng, endAng, prePoint) {
    ...
    const matrix = translate(prePoint.x - start.x, prePoint.y - start.y)
